...
@Controller
@RequestMapping(value = "/sedesLaboratorio")
...
public class SedesLaboratorioController {
    ...
    */
    ...
    public ModelAndView main() {
        ModelAndView modelAndView = new ModelAndView("administrar/sedesLaboratorio");

        return modelAndView;
    }

    @RequestMapping(value = "/guardarSedesLaboratorio", method = RequestMethod.POST)
    public ModelAndView saveLaboratorio(@ModelAttribute("sedeLaboratorioForm") /*Laboratorios loaboratoriosForm,*/ ModelAndView model) {
        //@Valid BindingResult bindingResult

        return new ModelAndView("redirect:/sedesLaboratorio/");
    }

    @RequestMapping(value = "/editarSedesLaboratorio/{nroIdLaboratorio}", method = RequestMethod.GET)
    public ModelAndView editarLaboratorio(@PathVariable long nroIdLaboratorio) {
        ...
        */
        ...
        ModelAndView modelAndView = main().addObject("sedesLaboratorioForm", "" /*laboratorio*/);
/*
